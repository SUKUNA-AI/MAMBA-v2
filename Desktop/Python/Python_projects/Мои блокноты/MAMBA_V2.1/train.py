...
def main():
    ...
    # Получаем датасеты и DataPreprocessor
    ...
    # Тестирование и обратное масштабирование результатов
    test_results = trainer.test(model, test_loader)
    # Если вам нужно обратное масштабирование предсказаний
    # Например, для анализа результатов:
    # predictions = trainer.predict(model, test_loader)
    # predictions = data_preprocessor.inverse_transform_targets(predictions)
